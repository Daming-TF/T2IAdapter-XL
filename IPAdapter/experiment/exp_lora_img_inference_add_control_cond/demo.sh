...
#export ControlnetModelPath="$MyPath/lllyasviel--control_v11p_sd15_openpose/"

python IPAdapter/experiment/exp_lora_img_inference_add_control_cond/exp-ipadapter_lora_downblocks_only.py \
