...
# DEFAULT_NEGATIVE_PROMPT = 'worst quality, normal quality, low quality, low res, blurry, text, watermark, logo, banner, ' \
...
DEFAULT_NEGATIVE_PROMPT = 'black and white'
...
def get_base_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        '--neg_prompt',
        type=str,
        default=None,   # DEFAULT_NEGATIVE_PROMPT,
